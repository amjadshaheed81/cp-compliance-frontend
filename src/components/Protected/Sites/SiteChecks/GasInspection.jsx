...
const GasInspection = ({
  ...
  const [formData, setFormData] = useState({
    ...
    jobNo: "",
    manufacturer: "",
    gasSafetyRegNo: loggedInUserData?.gasSafetyRegNo || "",
    modelNumber: "",
    position: "",
    floor: "",
    room: "",
  ...
  return (
    <div className="container mt-4 mb-5">
      <div className="header text-center bg-light p-4 mb-4 rounded">
        <h4 className="mb-0">
          Domestic landlord / Homeowner Gas Safety Record
        </h4>
      </div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="row mb-4">
          ...
          <div className="col-md-6">
            <div className="mb-3 d-flex">
              <div className="mb-3">
                <label className="form-label">Gas Safety Reg No</label>
                <input
                  type="text"
                  disabled
                  value={formData.gasSafetyRegNo || ""}
                  name="gasSafetyRegNo"
                  required
                  style={{
                    height: "40px",
