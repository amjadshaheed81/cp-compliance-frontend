...
import { Typography, Grid, IconButton, TextField, FormControlLabel, Checkbox, Box  } from "@mui/material";
              ...
              {formData.map((d, idx) => {
                return (
                  ...
                  <tr>
                    ...
                    {d.expanded && <tr>
                      <td style={{ backgroundColor: "#e8e9ea" }}  colSpan={12}>
                        <Box  >
                          <Grid container>
                            <Grid sm={6}>
                              <Box
                              ...
                              >
                                ...
                                <Grid container spacing={1} >
                                  ...
                                  <Grid item xs={12} sm={6} >
                                    <label htmlFor="folder" name="folder" style={{marginLeft: '5px'}}>
                                      Sample Number
                                    </label>
                                    <input
                                      type="text"
                                      value={"AS00"+formData?.[idx]?.sampleId??"0"}
                                      disabled
                                  ...
                                  <Grid item xs={12} sm={6}>
                                    <label htmlFor="riskType" name="riskType" style={{ marginLeft: '5px' }}>
                                      Internal/External
                                    </label>
                                    <select
                                  ...
                                  <Grid item xs={12} sm={6}>
                                    ...
                                    <label htmlFor="floor" name="floor" style={{ marginLeft: '5px' }}>
                                      Floor
                                    </label>
                                    <select
                                      disabled={formData[idx]?.completed}
                                  ...
                                  <Grid item xs={12} sm={6}>
                                    <label htmlFor="room" name="room" style={{ marginLeft: '5px' }}>
                                      Room
                                    </label>
                                    <select
                                      disabled={formData[idx]?.completed}
                                  ...
                                  <Grid item xs={12} sm={6}>
                                    ...
                                    <input
                                      ...
                                      disabled={formData[idx]?.completed}
                                      onChange={(e) => handleInputChange(e, idx)}
                                      value={formData[idx]?.licensedMaterial}
                                  ...
                                  <Grid item xs={12} sm={6}>
                                    ...
                                    <input
                                      ...
                                      name="identification"
                                      className="form-control"
                                      style={{ maxWidth: '300px', marginLeft: '5px', marginBottom: '10px' }}
                                    />

                                  </Grid>
                                  <Grid item xs={12} sm={6}>
                                  <FormControlLabel
                                      control={<Checkbox name="removedFromSite" onChange={(e) => handleCheckChange(e, idx)} />}
                                  ...
                                  <Grid item sm={12}>
                                    ...
                                    <textarea
                                      ...
                                      name="comment"
                                      className="form-control"
                                      style={{ maxWidth: '620px', marginLeft: '5px', marginBottom: '10px' }}
                                    />
                            ...
                            <Grid sm={6}>
                              <Grid container>
                                <Grid sm={12}><Box padding={2} style={{ backgroundColor: "white", margin: '10px', borderRadius: '5px' }}>
                                  <Typography variant="h6" gutterBottom>
                                    &nbsp;Material Assessment
                                  </Typography>
                                  <hr />
                                  <Grid container spacing={1}>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                      ...
                                      <select
                                        disabled={formData[idx]?.completed}
                                        onChange={(e) => handleInputChange(e, idx)}
                                        value={formData[idx]?.surfaceTreatment}
                                        className="form-control form-select"
                                    ...
                                    <Grid item xs={12} sm={6}>
                                      ...
                                      <select
                                        disabled={formData[idx]?.completed}
                                        onChange={(e) => handleInputChange(e, idx)}
                                        value={formData[idx]?.asbestosType}
                                        className="form-control form-select"
                                        name="asbestosType"
                                        required
                                        style={{ maxWidth: '300px', marginLeft: '5px', marginBottom:'20px' }}
                                      >
                                        <option value="">Select </option>
                                        {["Yes", "No"].map((num) => (
                                          <option value={num}>{num} </option>
                                ...
                                <Grid sm={12}><Box padding={2} style={{ backgroundColor: "white", margin: '10px', borderRadius: '5px' }}>
                                  ...
                                  <Grid container spacing={1}>
                                    <Grid item xs={12} sm={12}>
                                      <b style={{color: 'gray'}}>&nbsp;NORMAL ACTIVITY</b>
                                    </Grid>
                                    <Grid item xs={12} sm={6}>
                                      <label htmlFor="riskType" name="riskType" style={{ marginLeft: '5px' }}>
                                      ...
                                      <select
                                        disabled={formData[idx]?.completed}
                                        onChange={(e) => handleInputChange(e, idx)}
                                        value={formData[idx]?.mainActivityScore}
                                        className="form-control form-select"
                                    ...
                                    <Grid item xs={12} sm={6}>
                                      ...
                                      <select
                                        disabled={formData[idx]?.completed}
                                        onChange={(e) => handleInputChange(e, idx)}
                                        value={formData[idx]?.secondaryActivityScore}
                                        className="form-control form-select"
                                        name="secondaryActivityScore"
                                        required
                                        style={{ maxWidth: '300px', marginLeft: '5px', marginBottom: '5px' }}
                                      >
                                        <option value="">Select </option>
                                        {["Yes", "No"].map((num) => (
                                          <option value={num}>{num} </option>
                                    ...
                                    <Grid item xs={12} sm={12}>
                                      <b style={{ color: 'gray' }}>&nbsp;DISTURBANCE LIKELIHOOD</b>
                                    </Grid>
                                    <Grid item xs={12} sm={4}>
                                      ...
                                      <select
                                        ...
                                        name="location"
                                        required
                                        style={{ maxWidth: '190px', marginLeft: '5px' }}
                                      >
                                        <option value="">Select </option>
                                        {["Yes", "No"].map((num) => (
                                          <option value={num}>{num} </option>
                                    ...
                                    <Grid item xs={12} sm={4}>
                                      ...
                                      <select
                                        disabled={formData[idx]?.completed}
                                        onChange={(e) => handleInputChange(e, idx)}
                                        value={formData[idx]?.accessibility}
                                        className="form-control form-select"
                                        name="accessibility"
                                        required
                                        style={{ maxWidth: '190px', marginLeft: '5px' }}
                                    ...
                                    <Grid item xs={12} sm={4}>
                                      ...
                                      <select
                                        ...
                                        name="extent"
                                        required
                                        style={{ maxWidth: '190px', marginLeft: '5px', marginBottom: '5px' }}
                                      >
                                        <option value="">Select </option>
                                        {["Yes", "No"].map((num) => (
                                          <option value={num}>{num} </option>
                                    ...
                                    <Grid item xs={12} sm={12}>
                                      <b style={{ color: 'gray' }}>&nbsp;HUMAN EXPOSURE POTENTIAL</b>
                                    </Grid>
                                    <Grid item xs={12} sm={4}>
                                      <label htmlFor="riskType" name="riskType" style={{ marginLeft: '5px' }}>
                                        Number of occupants
                                    ...
                                    <Grid item xs={12} sm={4}>
                                      ...
                                      <select
                                        disabled={formData[idx]?.completed}
                                        onChange={(e) => handleInputChange(e, idx)}
                                        value={formData[idx]?.frequencyOfUse}
                                        className="form-control form-select"
                                        name="frequencyOfUse"
                                        required
                                        style={{ maxWidth: '190px', marginLeft: '5px' }}
                                    ...
                                    <Grid item xs={12} sm={4}>
                                      ...
                                      <select
                                        disabled={formData[idx]?.completed}
                                        onChange={(e) => handleInputChange(e, idx)}
                                        value={formData[idx]?.avgTimeInUse}
                                        className="form-control form-select"
                                        name="avgTimeInUse"
                                        required
                                        style={{ maxWidth: '190px', marginLeft: '5px', marginBottom: '5px' }}
                                    ...
                                    <Grid item xs={12} sm={6}>
                                      ...
                                      <select
                                        disabled={formData[idx]?.completed}
                                        onChange={(e) => handleInputChange(e, idx)}
                                        value={formData[idx]?.maintenanceActivityType}
                                        className="form-control form-select"
                                    ...
                                    <Grid item xs={12} sm={6}>
                                      ...
                                      <select
                                        disabled={formData[idx]?.completed}
                                        onChange={(e) => handleInputChange(e, idx)}
                                        value={formData[idx]?.maintenanceFrequency}
                                        className="form-control form-select"
                              ...
                              >
                                ...
                                <Grid container spacing={1} >
                                  ...
                                  <Grid item xs={6}>
                                    <Grid container >
                                      <Grid xs={12}>
                                        <div style={{ display: 'flex', gap: '10px', marginLeft: '5px', marginRight:'20px' }}>
                                      <div>
                                      ...
                                      <Grid item sm={12}>
                                        ...
                                        <textarea
                                          ...
                                          name="acmOption"
                                          className="form-control"
                                          style={{ maxWidth: '620px', marginLeft: '5px' }}
                                        />
                                      ...
                                      <Grid item sm={12}>
                                        ...
                                        <textarea
                                          ...
                                          disabled={formData[idx]?.completed}
                                          onChange={(e) => handleInputChange(e, idx)}
                                          value={formData[idx]?.measureAction}
                                          name="measureAction"
                                          className="form-control"
                                          style={{ maxWidth: '620px', marginLeft: '5px', marginBottom: '10px' }}
                                        />
                                    ...
                                    <Grid item xs={6}>
                                      ...
                                      <Grid item xs={12} sm={6}>
                                        ...
                                        <input
                                          ...
                                          disabled={formData[idx]?.completed}
                                          onChange={(e) => handleInputChange(e, idx)}
                                          value={formData[idx]?.remedialCost}
                                          name="remedialCost"
                                          className="form-control"
                                          style={{ maxWidth: '300px', marginLeft: '5px', marginBottom: '10px' }}
                                        />
                                      ...
                                      <Grid item xs={12} sm={6}>
                                        ...
                                        <input
                                          ...
                                          disabled={formData[idx]?.completed}
                                          onChange={(e) => handleInputChange(e, idx)}
                                          value={formData[idx]?.nextInspectionDate}
...
export default connect(mapStateToProps, { getUsers, deleteUser, getSites, getSiteAssets, getSiteLayout })(
  AsbestonSample
);
