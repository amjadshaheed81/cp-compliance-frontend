    ...
    const generatePDF = useCallback(async (uploadToServer = true) => {
        try {
            ...
            const engineer = users?.find(u => u.id === formData.engineer);
                ...
                console.log("[ShowerHeadCertificate][PDF] inputs", {
                    checkId: state.currentCheckId || checkId,
                    siteId: siteSelectedForGlobal?.siteId,
                    inspectionDate: formData.inspectionDate,
                    formattedDate,
                    assetId: formData.assetId,
                    selectedAsset: formData.selectedAsset,
                    selectedAssetResolved: selectedAsset,
                    engineerId: formData.engineer,
                    engineerResolved: engineer,
                });
            ...
            const fileName = `ShowerHeadCleaningCertificate_${selectedAsset?.assetName || formattedDate}.pdf`;
                ...
                console.log("[ShowerHeadCertificate][PDF] output", {
                    fileName,
                    usedAssetName: selectedAsset?.assetName || null,
                    usedFallbackDate: selectedAsset?.assetName ? null : formattedDate,
                    uploadToServer,
                });
