...
import { createDocumentFolder, uploadDocumentFile } from "../../../../store/thunk/site";
import { connect } from "react-redux";

const CreateFolder = ({ showFolderModal, setShowFolderModal, folderId, uploadDocumentFile }) => {
        ...
        <>
            ...
            >
                <Box sx={style}>
                    ...
                    <form class="row" onSubmit={handleSubmit(submitFolder)}>
                        <div class="col-md-8">
